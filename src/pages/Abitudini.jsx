...
import { useActivities, useRatings, useUserSettings, useInvalidateAll, useOptimisticRating, useOptimisticActivitySave, useGoals, useDayEntries, useSubscription } from '@/lib/useAppData';
import { useQueryClient } from '@tanstack/react-query';
import { useT } from '@/lib/i18n';
import { CATEGORIES, PRESET_ACTIVITIES } from '@/lib/constants';
import { Image } from '@/components/ui/image';
import ActivityIcon from '@/components/ActivityIcon';
import { computeStreak, computeFocusScore, todayISO } from '@/lib/productivity';
    ...
    <div className="px-5 safe-top pb-4">
      <header className="mb-6 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-xl bg-foreground px-3 py-2 text-sm font-semibold text-background"
        >
          <Plus size={16} /> {t('nuova')}
        </button>
      </header>
